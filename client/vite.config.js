...
export default defineConfig(({ mode }) => {
  ...
  return {
    define: {
      'import.meta.env.VITE_GIPHY_API_KEY': JSON.stringify(env.VITE_GIPHY_API_KEY || env.REACT_APP_GIPHY_API_KEY || ''),
      'import.meta.env.REACT_APP_GIPHY_API_KEY': JSON.stringify(env.REACT_APP_GIPHY_API_KEY || env.VITE_GIPHY_API_KEY || ''),
